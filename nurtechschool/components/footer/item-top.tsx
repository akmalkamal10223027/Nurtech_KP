...
export default function ItemTop({ data }: { data?: IFooterData }) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-background">
      {data && (
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 text-center sm:text-left">
          <div className="w-14 h-14 sm:w-16 sm:h-16 relative shrink-0">
            {iconSrc ? (
              ...
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white/20 flex items-center justify-center font-bold text-xs">
                LOGO
              </div>
            )}
          </div>
          <div className="flex flex-col gap-0.5 sm:gap-1 text-base sm:text-lg md:text-xl">
            ...
            {subItems.length > 0 && (
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 text-xs sm:text-sm mt-1.5">
                {subItems
      ...
      <div className="flex flex-row flex-wrap justify-center items-center gap-3 w-full sm:w-auto">
        <a
          href="#"
          target="_blank"
