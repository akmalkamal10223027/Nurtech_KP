...
export default function AppSection() {
    ...
    if (currentFeature) {
      return (
        <div
          ...
          className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10 animate-fadeIn w-full"
        >
  ...
  const renderDownloadButtons = () => {
    return (
      <div className="flex flex-row gap-2.5 sm:gap-3 pt-2 w-full justify-center sm:justify-start">
        <a
          href={data.appStoreLink || "#"}
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-2 sm:gap-2.5 bg-white text-gray-900 px-2.5 sm:px-4 py-2 sm:py-2.5 rounded-xl hover:bg-gray-100 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 min-w-0"
        >
          ...
          <div className="text-left min-w-0">
            <div className="text-[9px] sm:text-[10px] font-medium leading-tight whitespace-nowrap">Download di</div>
            <div className="text-[11px] sm:text-sm font-bold font-primary leading-none whitespace-nowrap">
              APP STORE
            </div>
          </div>
        </a>
  ...
  return (
    <section
      id="app-section"
      className="py-10 sm:py-14 bg-secondary-500 relative overflow-hidden w-full rounded-2xl sm:rounded-3xl"
    >
      <div className="absolute top-0 right-0 w-48 h-48 bg-primary-500/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-primary-500/5 rounded-full blur-2xl translate-y-1/2 -translate-x-1/2"></div>

      <div className="w-full px-4 sm:px-8 lg:px-12 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="text-white space-y-6">
            <span className="inline-block bg-primary-500 text-white px-3.5 py-1 rounded-full text-xs sm:text-sm font-semibold font-primary">
              {data.badge}
            </span>

            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold font-primary leading-tight">
            ...
            <p className="text-sm sm:text-base text-background/85 leading-relaxed">
              {data.description}
            </p>
